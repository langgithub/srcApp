...
public class BusRouteDetail2Activity extends Activity {
	...
	private void configureListView() {
		...
		mBusSegmentListAdapter = new BusSegmentListAdapter(
				BusRouteDetail2Activity.this, mBuspath.getSteps());
		int s= mBuspath.getSteps().size();
		ToastUtil.show(BusRouteDetail2Activity.this, 123, 6000);
